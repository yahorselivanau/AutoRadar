...
автоматический OIDC. В текущем приватном MVP интерфейс ищет только на Zap.by.
Код Remzona сохранён, но источник временно выключен.
...
- Текущий источник приватного MVP: `zap.by`; Remzona временно не вызывается.
